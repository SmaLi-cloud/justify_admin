<template>
  <div class="page-layout">
    ...
    <div ref="page" :class="['page-content', layout, pageWidth]" style="padding: 20px 20px 0;background: #fff;">
      <div class="beauty-scroll" :style="`height: ${innerHeight - 64-68}px;overflow-y:auto;overflow-x:hidden;padding-bottom:20px`">
        <slot></slot>
      </div>
    </div>
  </div>
