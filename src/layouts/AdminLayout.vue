<template>
  <a-layout :class="['admin-layout', 'beauty-scroll']">
    ...
    <NewSideMenu :class="[fixedSideBar ? 'fixed-side' : '']" :theme="theme.mode" v-if="layout === 'side' || layout === 'mix'" :menuData="sideMenuData" :collapsed="collapsed" :collapsible="true" />
    ...
    <a-layout class="admin-layout-main" style="overflow:hidden">
      <a-layout-header style="marginTop:" :class="['virtual-header', {'fixed-tabs' : fixedTabs, 'fixed-header': fixedHeader, 'multi-page': multiPage}]" v-show="false"></a-layout-header>
...
import NewSideMenu from '../components/newMenu/Menu'
...
export default {
  ...
  data () {
    return {
      minHeight: window.innerHeight - 64-68,
      collapsed: true,
      showSetting: false,
      drawerOpen: false
    }
  ...
  computed: {
    ...
    headerStyle() {
      ...
      return `width: 100%; position: ${position};`
    },
    headMenuData() {
