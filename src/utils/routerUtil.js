...
function updateMenuData() {
  ...
  const rootRoute = cloneOptions.routes.find(item => item.path === '/')
...
export {parseRoutes, loadRoutes, formatAuthority, getI18nKey, loadGuards, deepMergeRoutes, formatRoutes, setAppOptions, updateMenuData}
