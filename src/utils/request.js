...
async function post(action, params = {}) {
  ...
  data['action'] = action;
  return axios.post(process.env.VUE_APP_API_BASE_URL, data, { headers })
}
...
async function postForm( params = {}) {
  ...
  return axios.post(process.env.VUE_APP_API_BASE_URL, params, { headers })
}
...
function checkAuthorization(authType = AUTH_TYPE.BEARER) {
  switch (authType) {
    case AUTH_TYPE.BEARER:
      if(storage.get(process.env.VUE_APP_TOKEN_KEY)) {
        return true
      }
      break
    case AUTH_TYPE.BASIC:
