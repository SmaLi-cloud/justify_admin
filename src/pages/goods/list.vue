...
export default {
  ...
  computed: {
    ...mapState("goods", ["conditions"]),
    ...mapGetters("goods", ["formatConditions"]),
    columns() {
      let columns = [
        {
          title: "序号",
  ...
  methods: {
    ...mapMutations("goods", ["resetConditions", "setProductCount"]),
    ...
    getCustomList() {
      ...
      this.getGoodsList({
        ...
        .then((res) => {
          ...
          const { rows, productCount, count } = res.data;
